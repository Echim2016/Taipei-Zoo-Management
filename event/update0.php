<?php
	$tid = $_GET["update_id"];
	  ...
	  $data = mysql_query("select * from event where EV_ID ='$tid'");
            ...
            <div>
              <form class="news-letter" action="update.php?tid=<? echo $tid; ?>" method="post">
                  ...
                  <div class="subscribe-hide">
	                    <input class="form-control" type="email" id="insert_name" name="update_name" placeholder="Enter the event's name"  required>
						<input class="form-control" type="email" id="insert_sd" name="update_sd" placeholder="Enter the event's starting date! (yyyy-mm-dd)"  required>
						<input class="form-control" type="email" id="insert_ed" name="update_ed" placeholder="Enter the event's ending date! (yyyy-mm-dd)"  required>
