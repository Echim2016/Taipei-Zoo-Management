			...
			<div class="container">
				...
				<form class="news-letter" action="read.php" method="post">
					...
					<div class="subscribe-hide">
						<input class="form-control" type="email" id="subscribe-email" name="read_name" placeholder="Enter the event's name / id / date! (yyyy-mm-dd)"  required>
			...
			<div class="container">
				...
				<form class="news-letter" action="insert.php" method="post">
					<div class="subscribe-hide">
						...
						<input class="form-control" type="email" id="inser_id" name="insert_id" placeholder="Enter the event's id !"  required>
						<input class="form-control" type="email" id="insert_name" name="insert_name" placeholder="Enter the event's name"  required>
						<input class="form-control" type="email" id="insert_sd" name="insert_sd" placeholder="Enter the event's starting date! (yyyy-mm-dd)"  required>
						<input class="form-control" type="email" id="insert_ed" name="insert_ed" placeholder="Enter the event's ending date! (yyyy-mm-dd)"  required>
